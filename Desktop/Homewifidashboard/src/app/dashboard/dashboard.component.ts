...
export class DashboardComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.data.GetPromos().subscribe(
            ...
            this.data.GetPostpaidAccount('/09396988934').subscribe(
                data => {
                    this.accountBal$ = data
                    console.log("I got Account", data.AccountNo)
                    if(data){
                        this.data.GetPostpaidBalance(this.accountBal$.AccountNo).subscribe(result => {
                            console.log(result.Wallets[1]);
                            this.accountBal$ = result.Wallets[1];
                        });
                    }
